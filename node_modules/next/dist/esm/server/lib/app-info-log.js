...
export function logStartInfo({ networkUrl, appUrl, envInfo, experimentalFeatures, logBundler }) {
    let bundlerSuffix = '';
    if (logBundler) {
    ...
    Log.bootstrap(`${bold(purple(`${Log.prefixes.ready} Next.js ${"15.6.0-canary.58"}`))}${bundlerSuffix}`);
    if (appUrl) {
