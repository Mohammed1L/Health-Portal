...
function checkDeprecations(userConfig, configFileName, silent, dir) {
    var _userConfig_experimental, _userConfig_images_domains, _userConfig_images;
 ...
 */ function assignDefaultsAndValidate(dir, userConfig, silent, configuredExperimentalFeatures, phase) {
    var _userConfig_experimental, _result_experimental, _result_experimental1, _result_experimental_serverActions, _result_experimental2, _result_experimental3, _result_turbopack, _result_turbopack1, _result_devIndicators, _result_experimental4, _result_experimental5, _userConfig_experimental1, _result_experimental6;
    ...
    if (((_userConfig_experimental = userConfig.experimental) == null ? void 0 : _userConfig_experimental.dynamicIO) !== undefined) {
        ...
        if (((_userConfig_experimental2 = userConfig.experimental) == null ? void 0 : _userConfig_experimental2.cacheComponents) === undefined) {
    ...
    if (!((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.trustHostHeader) && ciEnvironment.hasNextSupport) {
    ...
    if (isStableBuild()) {
        var _result_experimental7, _result_experimental8, _result_experimental9;
        ...
        } else if ((_result_experimental8 = result.experimental) == null ? void 0 : _result_experimental8.cacheComponents) {
            throw Object.defineProperty(new CanaryOnlyError({
        ...
        } else if ((_result_experimental9 = result.experimental) == null ? void 0 : _result_experimental9.turbopackFileSystemCacheForBuild) {
            throw Object.defineProperty(new CanaryOnlyError({
    ...
    if (result.experimental) {
        ...
        result.experimental.cacheLife = {
            ...(_defaultConfig_experimental = defaultConfig.experimental) == null ? void 0 : _defaultConfig_experimental.cacheLife,
            ...result.experimental.cacheLife
        };
        const defaultDefault = (_defaultConfig_experimental1 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_cacheLife = _defaultConfig_experimental1.cacheLife) == null ? void 0 : _defaultConfig_experimental_cacheLife['default'];
        if (!defaultDefault || defaultDefault.revalidate === undefined || defaultDefault.expire === undefined || !((_defaultConfig_experimental2 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes = _defaultConfig_experimental2.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes.static)) {
        ...
        if (!defaultCacheLifeProfile) {
            ...
            if (defaultCacheLifeProfile.stale === undefined) {
                ...
                defaultCacheLifeProfile.stale = staticStaleTime ?? ((_defaultConfig_experimental3 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes1 = _defaultConfig_experimental3.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes1.static);
            }
    ...
    if (result.experimental.cacheComponents) {
        var _userConfig_experimental3, _userConfig_experimental4;
        if (((_userConfig_experimental3 = userConfig.experimental) == null ? void 0 : _userConfig_experimental3.ppr) === false || ((_userConfig_experimental4 = userConfig.experimental) == null ? void 0 : _userConfig_experimental4.ppr) === 'incremental') {
            var _userConfig_experimental5;
            throw Object.defineProperty(new Error(`\`experimental.ppr\` can not be \`${JSON.stringify((_userConfig_experimental5 = userConfig.experimental) == null ? void 0 : _userConfig_experimental5.ppr)}\` when \`experimental.cacheComponents\` is \`true\`. PPR is implicitly enabled when Cache Components is enabled.`), "__NEXT_ERROR_CODE", {
                value: "E729",
                enumerable: false,
                configurable: true
            });
        ...
        if (configuredExperimentalFeatures && // If we've already noted that the `process.env.__NEXT_EXPERIMENTAL_CACHE_COMPONENTS`
        // has enabled the feature, we don't need to note it again.
        process.env.__NEXT_EXPERIMENTAL_CACHE_COMPONENTS !== 'true' && process.env.__NEXT_EXPERIMENTAL_PPR !== 'true') {
            addConfiguredExperimentalFeature(configuredExperimentalFeatures, 'ppr', true, 'enabled by `experimental.cacheComponents`');
        }
    }
    // If ppr is enabled and the user hasn't configured rdcForNavigations, we
    // enable it by default.
    if (result.experimental.ppr && ((_userConfig_experimental1 = userConfig.experimental) == null ? void 0 : _userConfig_experimental1.rdcForNavigations) === undefined) {
        result.experimental.rdcForNavigations = true;
        if (configuredExperimentalFeatures) {
            addConfiguredExperimentalFeature(configuredExperimentalFeatures, 'rdcForNavigations', true, 'enabled by `experimental.ppr`');
        }
    }
    ...
    if (result.experimental.rdcForNavigations && !result.experimental.ppr) {
        throw Object.defineProperty(new Error('`experimental.rdcForNavigations` is enabled, but `experimental.ppr` is not.'), "__NEXT_ERROR_CODE", {
            value: "E800",
            enumerable: false,
            configurable: true
        });
    ...
    if (result.experimental.clientParamParsing && !result.experimental.clientSegmentCache) {
        throw Object.defineProperty(new Error(`\`experimental.clientParamParsing\` can not be \`true\` when \`experimental.clientSegmentCache\` is \`false\`. Client param parsing is only relevant when client segment cache is enabled.`), "__NEXT_ERROR_CODE", {
            value: "E787",
            enumerable: false,
            configurable: true
        });
...
export default async function loadConfig(phase, dir, { customConfig, rawConfig, silent = true, reportExperimentalFeatures, reactProductionProfiling, debugPrerender } = {}) {
    ...
    if (customConfig) {
        ...
        const config = await applyModifyConfig(assignDefaultsAndValidate(dir, {
            ...
            configFileName,
            ...customConfig
        }, silent, configuredExperimentalFeatures, phase), phase, silent);
    ...
    if (path == null ? void 0 : path.length) {
        ...
        const completeConfig = assignDefaultsAndValidate(dir, {
            ...
            configFileName,
            ...userConfig
        }, silent, configuredExperimentalFeatures, phase);
...
function enforceExperimentalFeatures(config, options) {
    ...
    (config.experimental.rdcForNavigations === undefined || isDefaultConfig && !config.experimental.rdcForNavigations)) {
        config.experimental.rdcForNavigations = true;
        if (configuredExperimentalFeatures) {
            addConfiguredExperimentalFeature(configuredExperimentalFeatures, 'rdcForNavigations', true, 'enabled by `__NEXT_EXPERIMENTAL_PPR`');
        }
    }
...
async function validateConfigSchema(userConfig, configFileName, warn) {
