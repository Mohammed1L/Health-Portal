...
import { createEntrypoints, createPagesMapping, finalizeEntrypoint, getClientEntry, getEdgeServerEntry, getAppEntry, runDependingOnPageType, getInstrumentationEntry } from '../../build/entries';
...
import { connectReactDebugChannel, deleteReactDebugChannel, setReactDebugChannel } from './debug-channel';
...
export default class HotReloaderWebpack {
    ...
    onHMR(req, _socket, head, callback) {
        wsServer.handleUpgrade(req, req.socket, head, (client)=>{
            ...
            const requestId = req.url ? new URL(req.url, 'http://n').searchParams.get('id') : null;
            ...
            const isLegacyClient = !requestId || !this.config.experimental.cacheComponents;
            callback(client, {
                isLegacyClient
            });
            ...
            client.on('close', ()=>{
                ...
                (_this_webpackHotMiddleware = this.webpackHotMiddleware) == null ? void 0 : _this_webpackHotMiddleware.deleteClient(client, requestId);
                if (requestId) {
