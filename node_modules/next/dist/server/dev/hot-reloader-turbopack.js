    ...
    const middlewares = [
        ...
        ...nextConfig.experimental.mcpServer ? [
            (0, _getmcpmiddleware.getMcpMiddleware)({
                ...
                getActiveConnectionCount: ()=>clientsWithoutRequestId.size + clientsByRequestId.size,
        ...
        onHMR (req, socket, head, onUpgrade) {
            wsServer.handleUpgrade(req, socket, head, (client)=>{
                ...
                (async function() {
                    ...
                    if (requestId) {
                        (0, _debugchannel.connectReactDebugChannel)(requestId, sendToClient.bind(null, client));
                    }
                })();
            });
        },
