...
class HotReloaderWebpack {
    ...
    onHMR(req, _socket, head, callback) {
        wsServer.handleUpgrade(req, req.socket, head, (client)=>{
            ...
            if (requestId) {
                (0, _debugchannel.connectReactDebugChannel)(requestId, this.sendToClient.bind(this, client));
            }
            client.on('close', ()=>{
                ...
                if (requestId) {
                    (0, _debugchannel.deleteReactDebugChannel)(requestId);
                }
            });
        });
    }
    ...
    setReactDebugChannel(debugChannel, htmlRequestId, requestId) {
        ...
        (0, _debugchannel.setReactDebugChannel)(requestId, debugChannel);
