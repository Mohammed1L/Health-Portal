    ...
    try {
      ...
      if (0 < abortableTasks.size)
        if (21 === request.type)
          ...
          request.pendingChunks++;
          emitErrorChunk(request, errorId$29, digest, error, !1, null);
          abortableTasks.forEach(function (task) {
            return abortTask(task, request, errorId$29);
          });
          setImmediate(function () {
            return finishAbort(request, abortableTasks, errorId$29);
          });
        }
      else {
        var onAllReady = request.onAllReady;
      ...
      logRecoverableError(request, error$30, null),
        fatalError(request, error$30);
    }
}
